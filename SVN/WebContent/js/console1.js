...
layui.use(["okUtils", "countUp"], function () {
    ...
    var userSourceTodayChartOption = {
        ...
        legend: {orient: 'vertical', left: 'left', data: ['DS101号电桩', 'DS102号电桩', 'DS103号电桩', 'DS104号电桩', 'DS105号电桩']},
        series: [
            {
                name: '访问来源', type: 'pie', radius: '55%', center: ['50%', '60%'],
                data: [{value: 335, name: 'DS101号电桩'}, {value: 310, name: 'DS102号电桩'}, {value: 234, name: 'DS103号电桩'}, {value: 135, name: 'DS104号电桩'}, {value: 1548, name: 'DS105号电桩'}],
    ...
    var userSourceWeekChartOption = {
        ...
        legend: {data: ['DS101号电桩', 'DS102号电桩', 'DS103号电桩', 'DS104号电桩', 'DS105号电桩']},
        toolbox: {show: false, feature: {saveAsImage: {}}},
        grid: {left: '3%', right: '4%', bottom: '3%', containLabel: true},
        xAxis: [{type: 'category', boundaryGap: false, data: ['周一', '周二', '周三', '周四', '周五', '周六', '周日']}],
        yAxis: [{type: 'value', splitLine: {show: false},}],
        series: [
            {name: 'DS101号电桩', type: 'line', stack: '总量', smooth: true, areaStyle: {}, data: [120, 132, 101, 134, 90, 230, 210]},
            {name: 'DS102号电桩', type: 'line', stack: '总量', smooth: true, areaStyle: {}, data: [220, 182, 191, 234, 290, 330, 310]},
            {name: 'DS103号电桩', type: 'line', stack: '总量', smooth: true, areaStyle: {}, data: [150, 232, 201, 154, 190, 330, 410]},
            {name: 'DS104号电桩', type: 'line', stack: '总量', smooth: true, areaStyle: {normal: {}}, data: [320, 332, 301, 334, 390, 330, 320]},
            {name: 'DS105号电桩', type: 'line', stack: '总量', smooth: true, label: {normal: {show: true, position: 'top'}}, areaStyle: {normal: {}}, data: [370, 932, 901, 934, 1290, 1330, 1320]}
        ]
    };
